...
{
    public partial class FBuscarBarbero : Form
    {
        public int indice = 0, vtieneparametro = 0;
        public string valorparametro = "";
        public FBuscarBarbero()
        {
            InitializeComponent();
        }
        ...
        private void FConsultaBarbero_Load(object sender, EventArgs e)
        {
            valorparametro = "";
            vtieneparametro = 0;
            Program.vidBarbero = 0; //variable global que tomará el valor seleccionado
        ...
        private void FConsultaBarbero_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void bAceptar_Click(object sender, EventArgs e)
        {
            if (DGVDatos.CurrentRow != null) //Si el DataGridView no está vacío
            {
                ...
                Program.vidBarbero = Convert.ToInt32(DGVDatos.CurrentRow.Cells[0].Value);
            }
            Close();
        ...
        {
            valorparametro = tbBuscar.Text.Trim();
            CNBarbero objBarbero = new CNBarbero();
            if (objBarbero.ObtenerBarbero(valorparametro) != null)
            {
                DGVDatos.DataSource = objBarbero.ObtenerBarbero(valorparametro);
